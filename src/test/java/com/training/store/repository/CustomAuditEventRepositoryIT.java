package com.training.store.repository;

import com.training.store.StoreApp;
import com.training.store.config.Constants;
import com.training.store.config.audit.AuditEventConverter;
import com.training.store.domain.PersistentAuditEvent;
...
import static com.training.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
